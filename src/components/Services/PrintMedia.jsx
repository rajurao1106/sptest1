    ...
    <div className="service-con">
      ...
      <div className="topic-align1">
        <img src={print_img2} alt="" data-aos="zoom-in"/>
          <div className='topic-left' data-aos="fade-right">
            <h1>Brochure</h1>
            <p className='dr'>A brochure is a printed booklet that provides detailed information about products, services, or organizations. It uses high-quality graphics and structured content to inform and persuade potential customers, often distributed in public places or direct mail.</p>
          </div>
        </div>
      ...
      <div className="topic-align1" id='topic-align2'>
          ...
          <img src={Pamphlet} alt="" data-aos="zoom-in"/>
        </div>
        
      
    
      <div className="topic-align1">
        <img src={inshop3} alt="" data-aos="zoom-in"/>
          <div className='topic-left' data-aos="fade-right">
